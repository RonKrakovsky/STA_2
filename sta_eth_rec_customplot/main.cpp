...
int main(int argc, char* argv[])
{
    ...
    QObject::connect(window.dispMenu, &DispMenu::hold_change,
		     &dp, &DataProvider::handlehold_change);

    QObject::connect(window.dispMenu, &DispMenu::holdmax_change,
		     &dp, &DataProvider::handleholdmax_change);
