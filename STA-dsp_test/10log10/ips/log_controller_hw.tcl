...
# 
# log_controller "log_controller" v0.1
# Nitzan Lavi 
# 
# 
...
set_fileset_property quartus_synth TOP_LEVEL log_controller
set_fileset_property quartus_synth ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property quartus_synth ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file log_controller.vhd VHDL PATH ../source/log_controller.vhd TOP_LEVEL_FILE
add_fileset_file log10.vhd VHDL PATH ../source/log10.vhd
add_fileset_file log_v2.vhd VHDL PATH ../source/LOG/log_v2.vhd
add_fileset_file fix_to_float.qip VHDL PATH ../source/f2f/fix_to_float.qip
add_fileset_file fix_to_float.vhd VHDL PATH ../source/f2f/fix_to_float.vhd
add_fileset_file fix_to_float_0002.bhd VHDL PATH ../source/f2f/fix_to_float/fix_to_float_0002.vhd
add_fileset_file dspba_library.bhd VHDL PATH ../source/f2f/fix_to_float/dspba_library.vhd
add_fileset_file dspba_library_package.bhd VHDL PATH ../source/f2f/fix_to_float/dspba_library_package.vhd
# add_fileset_file i2f.vhd VHDL PATH ../source/conv_int2FP/i2f.vhd
# add_fileset_file f2i.vhd VHDL PATH ../source/conv_FP2FIX/f2i.vhd
# add_fileset_file conv_int2FP.vhd VHDL PATH ../source/conv_int2FP/conv_int2FP.vhd
# add_fileset_file conv_FP2FIX.vhd VHDL PATH ../source/conv_FP2FIX/conv_FP2FIX.vhd
...
set_parameter_property DATA_WIDTH DISPLAY_NAME {Input Integer Data Width}
set_parameter_property DATA_WIDTH TYPE INTEGER
set_parameter_property DATA_WIDTH UNITS bits
set_parameter_property DATA_WIDTH ALLOWED_RANGES 2:128
set_parameter_property DATA_WIDTH DESCRIPTION {Input Integer Data Width}
set_parameter_property DATA_WIDTH AFFECTS_GENERATION {1}
set_parameter_property DATA_WIDTH HDL_PARAMETER true

add_parameter DATA_OUT_WIDTH INTEGER 32
set_parameter_property DATA_OUT_WIDTH DEFAULT_VALUE 32
set_parameter_property DATA_OUT_WIDTH DISPLAY_NAME {Output Float Data Width}
set_parameter_property DATA_OUT_WIDTH TYPE INTEGER
set_parameter_property DATA_OUT_WIDTH UNITS bits
set_parameter_property DATA_OUT_WIDTH ALLOWED_RANGES 2:64
set_parameter_property DATA_OUT_WIDTH DESCRIPTION {Output Float Data Width}
set_parameter_property DATA_OUT_WIDTH AFFECTS_GENERATION {1}
...
set_interface_property fifo_source associatedClock clock
...
set_interface_property fifo_sink associatedClock clock
...
proc elaborate_me {}  {   
   ...
   set data_out_width [get_parameter_value DATA_OUT_WIDTH]
   ...
   set source_data_width [expr {$data_out_width + $rffe_info_width}]
   #source data width = signal + amps + filters + attenuator + protection + error
   set source_fragment_list "source_signal $data_out_width source_amps $amps_width source_filters $filters_width"
   ...
   set_interface_property source dataBitsPerSymbol $source_data_width
   ...
   dsp_add_interface_port source source_data data Output $source_data_width $source_fragment_list
   ...
   set_interface_property rffe_fifo_sink associatedClock clock
   ...
   dsp_add_interface_port rffe_fifo_sink rffe_fifo_sink_data data Input $rffe_info_width $rffe_fifo_sink_data_fragment_list 
   ...
   set_interface_property rffe_fifo_source associatedClock clock
   ...
   dsp_add_interface_port rffe_fifo_source rffe_fifo_source_data data Output $rffe_info_width $rffe_fifo_source_fragment_list
